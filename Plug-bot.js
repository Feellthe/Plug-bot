...
function displayUI() 
{
    ...
    var cMeh = automeh ? '#3FFF00' : '#ED1C24';

    $('#plugbot-ui').append(
        '<p id="plugbot-btn-woot" style="color:' + cWoot + '">auto-woot</p><p id="plugbot-btn-meh" style="color:' + cMeh + '">auto-meh</p><p id="plugbot-btn-queue" style="color:' + cQueue + '">auto-queue</p><p id="plugbot-btn-hidevideo" style="color:' + cHideVideo + '">hide video</p><p id="plugbot-btn-skipvideo" style="color:#ED1C24">skip video</p><p id="plugbot-btn-userlist" style="color:' + cUserList + '">userlist</p>');
}
...
function initUIListeners() 
{
    ...
    $('#plugbot-btn-meh').on('click', function() 
	{
        automeh = !automeh;
        $(this).css('color', autowoot ? '#3FFF00' : '#ED1C24');
        ...
        jaaulde.utils.cookies.set(COOKIE_MEH, automeh);
    });
...
function readCookies() 
{
    ...
    var value = jaaulde.utils.cookies.get(COOKIE_MEH);
    automeh = value != null ? value : false;
